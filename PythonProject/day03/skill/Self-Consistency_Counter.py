...
def majority_vote(responses):
    ...
    print(counter) # 会对responses生成投票次数键值对。
    # print(counter)
    # {
    #     '当我6岁时，我的妹妹是我的一半年龄，这意味着她当时是6 ÷ 2 = 3岁。因此，我的妹妹比我小6 - 3 = 3岁。现 在我70岁了，所以我的妹妹是70 - 3 = 67岁。答案是67。': 2,
    #     '当我6岁时，我的妹妹是我的一半年龄，这意味着她当时是6 ÷ 2 = 3岁。  \n我和妹妹之间的年龄差始终是6 - 3 = 3岁。  \n现在我70岁了，所以我的妹妹是70 - 3 = 67岁。  \n\n**答案是：** **{67}**': 1,
    #     '当我6岁时，我的妹妹是我的一半年龄，这意味着她当时是6 ÷ 2 = 3岁。  \n因此，我比我的妹妹大3岁。  \n现在我70岁了，所以我的妹妹是70 - 3 = 67岁。  \n\n答案是：**67**': 1,
    #     '当我6岁时，我的妹妹是我的一半年龄，这意味着她当时是6 ÷ 2 = 3岁。  \n我和妹妹的年龄差始终是6 - 3 = 3岁。  \n现在我70岁了，所以我的妹妹是70 - 3 = 67岁。  \n\n答案是：**67**': 1
    # }
    #第二个值是次数，我们这里不需要，所以取第一个值
    # 按「得票数从高到低」对答案进行排序；
    # 传入参数n表示「取前 n 个得票最高的答案」；
    # 返回结果是列表，列表中每个元素是(答案, 得票次数)的元组。
